...
const allProducts = [
  { id: 1, title: "Bande adhésive à découper", image_url: require('./../../images/img/107.webp'), is_featured: false },
  { id: 2, title: "Bande crêpe", image_url: require('./../../images/img/108.webp'), is_featured: false },
  { id: 3, title: "Bandelettes adhésives prédécoupées", image_url: require('./../../images/img/109.webp'), is_featured: false },
  { id: 4, title: "Bassin de lit en plastique", image_url: require('./../../images/img/110.webp'), is_featured: false },
  { id: 5, title: "Blouse renforcée 75 g/m²", image_url: require('./../../images/img/111.webp'), is_featured: false },
  { id: 6, title: "Blouse standard 35 g/m²", image_url: require('./../../images/img/112.webp'), is_featured: false },
  { id: 7, title: "Boîte à pharmacie", image_url: require('./../../images/img/113.webp'), is_featured: false },
  { id: 8, title: "Boule de coton 5 g (sachet de 100)", image_url: require('./../../images/img/114.webp'), is_featured: false },
  { id: 9, title: "Canule de Guedel stérile", image_url: require('./../../images/img/115.webp'), is_featured: false },
  { id: 10, title: "Canule nasale à oxygène (adulte, enfant, pédiatrie)", image_url: require('./../../images/img/116.webp'), is_featured: false },
  { id: 11, title: "Cathéter de Foley ballon", image_url: require('./../../images/img/117.webp'), is_featured: false },
  { id: 12, title: "Cathéter de Foley ballon silicone", image_url: require('./../../images/img/118.webp'), is_featured: false },
  { id: 13, title: "Cathéter externe pour homme", image_url: require('./../../images/img/119.webp'), is_featured: false },
  { id: 14, title: "Cathéter Nelaton", image_url: require('./../../images/img/120.webp'), is_featured: false },
  { id: 15, title: "Charlotte double élastique PP 12 g, 19″ (paquet de 100)", image_url: require('./../../images/img/121.webp'), is_featured: false },
  { id: 16, title: "Combinaison de protection", image_url: require('./../../images/img/122.webp'), is_featured: false },
  { id: 17, title: "Compresse laparotomique 50 × 40 cm (6 pcs/sachet)", image_url: require('./../../images/img/123.webp'), is_featured: false },
  { id: 18, title: "Compresse stérile RX (sachet de 5 et 10)", image_url: require('./../../images/img/124.webp'), is_featured: false },
  { id: 19, title: "Compresses non stériles (pochette de 100)", image_url: require('./../../images/img/125.webp'), is_featured: false },
  { id: 20, title: "Compresses stériles 10 × 10 cm – 16 plis", image_url: require('./../../images/img/126.webp'), is_featured: false },
  { id: 21, title: "Compresses stériles 30 × 30 cm (boîte de 10)", image_url: require('./../../images/img/127.webp'), is_featured: false },
  { id: 22, title: "Compresses stériles (sachet de 5 et 10)", image_url: require('./../../images/img/128.webp'), is_featured: false },
  { id: 23, title: "Coton hydrophile 500 g et 1 kg", image_url: require('./../../images/img/129.webp'), is_featured: false },
  { id: 24, title: "Couvercle de bassin de lit en plastique", image_url: require('./../../images/img/130.webp'), is_featured: false },
